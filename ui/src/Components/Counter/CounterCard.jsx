    ...
    return (
        <div>
            <div className="card-group my-4 text-center rounded-0 ">
                <div className="card myshadow rounded rounded-0 mx-1"
                    style={{ background: ComputerCard, color: ComputerCardText }} data-aos="fade-up" data-aos-duration="300">
                ...
                <div className="card myshadow  rounded rounded-0 mx-1" style={{ background: BookCard, color: BookCardText }}
                ...
                <div className="card myshadow rounded rounded-0 mx-1"
                    style={{ background: ComputerCard, color: ComputerCardText }} data-aos="fade-up" data-aos-duration="1000">
                    <div className="card-body  ">
                        <h1 className=" w-100 m-auto mt-1 py-5 fw-bolder  text-white counter"
