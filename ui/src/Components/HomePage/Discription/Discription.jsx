            ...
            <div className="row" id="conditions">
                ...
                <div className="row">
                    <div className="col-md-12">
                        <ul>
                            <li className="hoverTextOrange">This official website of Drishti Institute of Information Technology, Drishti has been developed to "provide information to the general public."</li>
